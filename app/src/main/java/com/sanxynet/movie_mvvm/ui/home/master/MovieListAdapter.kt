package com.sanxynet.movie_mvvm.ui.home.master
...
import com.sanxynet.movie_mvvm.common.utils.dp
import com.sanxynet.movie_mvvm.databinding.RowMovieListBinding
...
class MovieListAdapter(val context: Context?, var items: List<Movie> = ArrayList()) : RecyclerView.Adapter<ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvMovieDescription.text = context?.getString(
            R.string.movie_row_desc_pattern,
